...
- (IBAction)onReset:(id)sender
{
    ...
    {
        [UIAlertView bk_showAlertViewWithTitle:@"Error" message:@"You must provide the email address of your LiveRosary account." cancelButtonTitle:@"Ok" otherButtonTitles:nil handler:nil];
        return;
    }
